...
@Client.on_message(command(["/mplay","شغيل","شغيل اغنيه","/play","بودا", f"/mplay@{BOT_USERNAME}"]) & other_filters)
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
              ...
              [InlineKeyboardButton("𝙎𝙊𝙐𝙍𝘾𝙀 𝑩𝑶𝑫𝑨 𖡛“.", url=f"https://t.me/k_2aba"),
                ],
