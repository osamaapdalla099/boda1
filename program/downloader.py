...
def song(_, message):
    ...
    try:
        ...
        rep = f"🎧 تم تحميل بواسطة [🎶 𝑩𝑶𝑫𝑨 𝑀𝑈𝑆𝐼𝐶࿃  ](https://t.me/x3j_xj3)"
...
@Client.on_message(
    command(["vsong", "حميل_فيديو","تحميل فديو","تنزيل فديو", f"vsong@{BOT_USERNAME}", "video", f"video@{BOT_USERNAME}"]) & ~filters.edited
)
async def vsong(client, message):
    ...
    try:
        ...
        print(e)
    try:
        msg = await message.reply("🎧 تم تحميل بواسطة [🎶 𝑩𝑶𝑫𝑨 𝑀𝑈𝑆𝐼𝐶࿃  ](https://t.me/x3j_xj3)")
